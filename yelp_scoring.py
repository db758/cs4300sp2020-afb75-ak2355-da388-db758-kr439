...
def get_key_words():
  ...
  for res in restaurants:
    result_cat.union(tokenize_categories(res['categories']))
    result_att.union(tokenize_attributes(res['attributes']))
  ...
  with open('output.csv', mode='w') as csv_file:
    ...
    print(length)
    for a, c, in result_att, result_cat:
      writer.writerow({'category': c, 'attribute': a})
